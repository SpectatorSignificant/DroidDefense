...
const text1 = "Use Arrow keys or WASD to move the player left and right";
...
const text6 = "The Base Health reduced when the base is hit by incoming bots";
const text7 = "The BOSS shoots homing missiles that are faster and do more emoji";
const text8 = "The game ends when Base Health is zero or if the player is hit by a bot";
...
function instructions(){
    ...
    c.fillStyle = "white";
    c.font = "15px Courier New";
    c.fillText(text8, canvas.width*0.25, canvas.height*0.76);
    c.fillStyle = "white"
            ...
            for (var i = 0; i < circles.length; i++){
                for (var j = i + 1; j < circles.length; j++){
                    if (circles[i].x == circles[j].x && circles[i].y == circles[j].y){
                        //var px = circles[i].x**2 + circles[j].x**2;
                        //var qx = circles[i].x + circles[j].x;
                        //var py = circles[i].y**2 + circles[j].y**2;
                        //var qy = circles[i].y + circles[j].y;
                        //var x1 = qx/2 + (2*px + qx - 2*px**2)**0.5/2;
                        //var x2 = qx/2 - (2*px + qx - 2*px**2)**0.5/2;
                        //if ()
